...
class TestDownloadManager(unittest.TestCase):
    ...
    @patch('src.download_manager.snapshot_download')
    def test_download_model_update_failure_redownloads(self, mock_snapshot, mock_rmtree):
    ...
    @patch('src.download_manager.shutil.rmtree')
    @patch('src.download_manager.snapshot_download')
    def test_download_dataset_update_failure_redownloads(self, mock_snapshot, mock_rmtree):
    ...
    @patch('src.download_manager.shutil.rmtree')
    @patch('src.download_manager.git.Repo')
    def test_download_codebase_update_failure_reclones(self, mock_repo_class, mock_rmtree):
        ...
        mock_repo_class.side_effect = [mock_repo_instance, None]  # First call fails, clone_from succeeds
    ...
    def test_download_model_resources_all(self, mock_git, mock_snapshot):
        ...
        model_path, codebase_path, dataset_path = self.dm.download_model_resources(model_urls)
    ...
    def test_download_model_resources_always_updates(self, mock_git, mock_snapshot):
        ...
        result_model, result_codebase, result_dataset = self.dm.download_model_resources(model_urls)
